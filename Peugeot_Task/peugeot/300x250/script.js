...
function runAnimation(){
  ...
  setTimeout(function(){
    ...
    setTimeout(function(){
      ...
      document.querySelector('.winne-logo').style.opacity = 1;
...
function animateCTA()
{
  document.querySelector('.top-line').style.width  = "110px";
  document.querySelector('.bottom-line').style.width   = "110px";
  setTimeout(function(){
    document.querySelector('.left-line').style.height   = "26px";
    document.querySelector('.right-line').style.height  = "26px";
   }, 700);
}

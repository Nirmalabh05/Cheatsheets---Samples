...
function animateCTA()
{
  document.querySelector('.top-line').style.width  = "170px";
  document.querySelector('.bottom-line').style.width   = "170px";
  setTimeout(function(){
    document.querySelector('.left-line').style.height   = "41px";
    document.querySelector('.right-line').style.height  = "41px";
   }, 700);
}
